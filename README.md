...
| `writing`        | [`holding-analytical-judgment`](skills/writing/holding-analytical-judgment/SKILL.md) | Keep analysis grounded in evidence when the subject pushes back emotionally; do not flip conclusions for mood alone (code review, diagnosis, post-mortems, relationship-style analysis) |
